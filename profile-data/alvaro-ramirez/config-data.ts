...
const IMAGE_DATA = {
    COVERPAGE: '/profile/alvaro-ramirez/ALVARO_PORTADA.png', //CAMBIAR DIRECCION DE LAS IMAGENES
    INFORMATION: '/profile/alvaro-ramirez/ALVARO_GALERIA-03.png',
    AVATAR: '/profile/alvaro-ramirez/ALVARO_PERFIL.png',
    GALLERY_1: '/profile/alvaro-ramirez/ALVARO_GALERIA-04.png',
    GALLERY_2: '/profile/alvaro-ramirez/ALVARO_GALERIA-05.png',
    GALLERY_3: '/profile/alvaro-ramirez/ALVARO_GALERIA-06.png'
}

const CONTACT_DATA = {
    EMAIL: 'alvaroramirez5457@gmail.com',
    PHONE: '57 313 7977920',
    ADDRESS: ' Calle 100',
    NUMBER: '#33-32',
    LOCALITY: 'La Enea',
    PROVINCE: 'Manizales',
...
const SOCIALNET_DATA = {
    LINKEDIN: 'https://www.linkedin.com/in/%C3%A1lvaro-ramirez-londo%C3%B1o-081289225/',
    YOUTUBE: '',
    TWITTER: '',
    FACEBOOK: 'https://www.facebook.com/alvaro.ramirezlondono.9',
    INSTAGRAM: 'https://instagram.com/alvaroramirez5457',
    TIKTOK: '',
    WIJEX: 'https://comunidad.wijex.com/alvaroramirez5457',
    TELEGRAM: ''
}

const CURRICULUM_DATA = {
    CURRICULUM_VITAE: '/profile/alvaro-ramirez/productos-wijex.pdf'
}
